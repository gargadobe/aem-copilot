...
export const AEM_BLOCK_COLLECTION_URL = `https://main--aem-block-collection--adobe.hlx.live/blocks`;

export const BLOCK_COLLECTION_LIST = ['accordion', 'cards', 'carousel', 'columns', 'embed', 'footer', 'form', 'fragment', 'header', 'hero', 'modal', 'quote', 'search', 'table', 'tabs', 'video'];